...
DATA=train_combined-qalb_15_real_w2+qalb_15_synth_t20_w1+arabil_sample_50k_t25_w1
...
for lr in 5e-5; do
  CUDA_VISIBLE_DEVICES=0 python -m gec.train \
    ...
    --do_train --do_eval \
    --run_name finetune_arabart_synthetic_w2_jan_4_2025 \
...
model_path=${output_dir}_lr5e-5/checkpoint-50000
