...
for run in qalb-14,qalb-14 qalb-14+qalb-15,qalb-14_qalb-15 qalb-14+qalb-15+ZAEBUC,qalb-14_qalb-15_ZAEBUC; do
    ...
    CUDA_VISIBLE_DEVICES=0 python -m gec.train \
        ...
        --output_dir ../checkpoints/ablation/finetuning/base_model_pretrain_1.3M_train_dist_synthetic_gec_ft_data_${dataset}_no_morph_lr_3e-4 \
        --do_train --do_eval \
        --run_name ABLATION_ft_no_morph_synth_1_3M_train_dist_${run_name} \
