...
DATA=train
output_dir=../checkpoints/paper/finetuning_arabart/qalb15zaebuc_${DATA}


CUDA_VISIBLE_DEVICES=0 python -m gec.train \
  --train_file ../data/real/clean/qalb-14+qalb-15+ZAEBUC/jsonl/${DATA}.jsonl \
  ...
  --do_train --do_eval \
  --run_name PAPER_finetune_arabart_z \
...
output_root=../outputs/paper/finetuning_arabart/qalb15zaebuc_${DATA}
